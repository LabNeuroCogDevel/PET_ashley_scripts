...
r2p=r2p_cic_${new_condition}_res

3dLME -prefix 3dLME_R2pres_sex_RS2_maineff_frontmask_$condition -jobs 20 \
   -mask $fmask \
   -model "context*$r2p+fdstat_funcmean+hemi+sex+visitnum" \
   -ranEff '~1' \
   -qVars "fdstat_funcmean,$r2p" \
   -SS_type 3 \
   -num_glt 6 \
   ...
   -gltLabel 4 'r2p_BG' -gltCode 4 "context : 1*BG $r2p :" \
   -gltLabel 5 'r2p_RS' -gltCode 5 "context : .5*RS1 +.5*RS2 $r2p :" \
   -gltLabel 6 'r2p' -gltCode 6 "$r2p" \
   -dataTable @${condition}Xcontext_RS2_goodr2p.txt

done

3dLME -prefix 3dLME_R2pres_sex_RS2_maineff_frontmask_VTA -jobs 20 \
   -mask $fmask \
   -model "context*$r2p+fdstat_funcmean+sex+visitnum" \
   -ranEff '~1' \
   -qVars "fdstat_funcmean,$r2p" \
   -SS_type 3 \
   -num_glt 6 \
   ...
   -gltLabel 5 'r2p_RS' -gltCode 5 "context : .5*RS1 +.5*RS2 $r2p :" \
   -gltLabel 6 'r2p' -gltCode 6 "$r2p" \
   -dataTable @VTAXcontext_RS2_goodr2p.txt
