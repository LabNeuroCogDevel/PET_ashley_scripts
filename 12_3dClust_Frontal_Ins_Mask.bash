...
#fi
fmask=$ATLASDIR/acp_front_ins_mni_rs.nii.gz
...
3dClustSim \
   -acf $acf1 $acf2 $acf3 \
   -mask $fmask > ${condition}_clustSim_frontal_insmask_rs.txt 
   #-jobs 20

3dClustSim \
   -acf $acf4 $acf5 $acf6 \
   -mask $fmask > ${condition}_clustSim_frontal_insmask_bg.txt 
   #-jobs 20

3dClustSim \
   -acf $acf7 $acf8 $acf9 \
   -mask $fmask > ${condition}_clustSim_frontalins_mask_bgrs.txt 
   #-jobs 20
