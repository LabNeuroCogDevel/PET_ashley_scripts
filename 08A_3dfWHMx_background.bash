...
#Title: 3dfWHMx_background_08.bash
#Author: Ashley Parr
...
for subj in $DATADIR/1*; do
   for condition in $conditions; do
      ...
      errtsFname=$sub_id/background_connectivity/${sub_id}_3ddeconvolve_model_resid_${condition}+tlrc.HEAD
      ...
      3dFWHMx -acf -overwrite \
         -mask $gmmask \
         -input ${errtsFname} | sed 's/ \+/ /' | sed 1d > $subj/background_connectivity/${sub_id}_GC_acf_${condition}.txt &
      sleep .25
      waitforjobs
   done
done
